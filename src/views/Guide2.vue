            ...
            <div class="guide-box mb-5 pt-5 pb-5">
              <div class="login-right">
                <div class="guide-header text-center">
                  <h1 class="mb-4"><span>Rules</span></h1>
                  <ul class="mb-4">
                    <li class="mb-4">
                      <b>Be creative!</b> Aim for ideas that are clever, unusual, interesting,
                      uncommon, humorous, innovative, or different.
                    </li>
                    <li class="mb-4">Points will be awarded based on idea originality.</li>
                    <li>Please do NOT use the internet to help you ☺</li>
                  </ul>
                </div>
                <div class="text-center">
                  <router-link to="/guide-3">
